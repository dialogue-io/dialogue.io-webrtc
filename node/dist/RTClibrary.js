...
(function(exports) {
	...
	var Conference = function() {
			...
			if (remoteVideo == null) {
				getElement(div, function(element){
					if (element==false) {
						...
						remoteVideo.setAttribute("style","-webkit-transition: opacity 2s; -webkit-transform: scale(-1, 1); opacity: 1; margin-right: 3px;");
		...
		function createPeerConnection() {
			try {
		    	PeerConn = new webkitPeerConnection00("STUN stun.l.google.com:19302", onIceCandidate);
